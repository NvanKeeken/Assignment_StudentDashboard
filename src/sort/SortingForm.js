...
function SortingForm(props) {
  return (
    <form
      className="sort-form"
      onChange={(e) => props.sortRating(e, e.target.placeholder)}
    >
      <div className="sort-difficult">
        <label className="sort-form__label"> Sort by Difficulty</label>
      ...
      <div className="sort-enjoyment">
        <label className="sort-form__label">Sort by Enjoyment</label>
